...
- `decisions/`: ADRs (Architecture Decision Records). Decisiones técnicas importantes.
...
3. **Consolidación:** Cuando una funcionalidad se estabiliza, la información relevante de `live/` se destila y se migra hacia `current_state.md` y `foundations/`.
